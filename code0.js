...
gdjs.Level_321Code.GDFloorcaps_9595solidObjects1= [];
gdjs.Level_321Code.GDFloorcaps_9595solidObjects2= [];
gdjs.Level_321Code.GDFloorcaps_9595solidObjects3= [];
gdjs.Level_321Code.GDFloorcaps_9595solidObjects4= [];
gdjs.Level_321Code.GDFloorcaps_9595solidObjects5= [];
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12680572);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12682444);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("KnightArtwork"), gdjs.Level_321Code.GDKnightArtworkObjects4);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12684116);
}
}
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("KnightArtwork"), gdjs.Level_321Code.GDKnightArtworkObjects3);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10072220);
}
}
if (isConditionTrue_0) {
...
gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDKnightHitBoxObjects2Objects = Hashtable.newFrom({"KnightHitBox": gdjs.Level_321Code.GDKnightHitBoxObjects2});
gdjs.Level_321Code.mapOfGDgdjs_9546Level_9595321Code_9546GDDoorObjects2Objects = Hashtable.newFrom({"Door": gdjs.Level_321Code.GDDoorObjects2});
gdjs.Level_321Code.asyncCallback10082340 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.Level_321Code.asyncCallback10082340(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10082140);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10083380);
}
}
if (isConditionTrue_0) {
}
...
gdjs.Level_321Code.GDFloorcaps_9595solidObjects1.length = 0;
gdjs.Level_321Code.GDFloorcaps_9595solidObjects2.length = 0;
gdjs.Level_321Code.GDFloorcaps_9595solidObjects3.length = 0;
gdjs.Level_321Code.GDFloorcaps_9595solidObjects4.length = 0;
gdjs.Level_321Code.GDFloorcaps_9595solidObjects5.length = 0;
